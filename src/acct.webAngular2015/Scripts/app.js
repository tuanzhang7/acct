(function () {
    ...
    .run(function ($httpBackend) {
        ...
        $httpBackend.whenGET('/customer/10').respond(function (method, url, data, headers) {
            return [200, customer, {  }, "OK"];
        });

        $httpBackend.whenGET('invoice/customer/10').respond(function (method, url, data, headers) {
            return [200, invocies, {}, "OK"];
        });
